---
title: "cross validation and prediction: part d, or 'Crossing the river'"
author: ""
date: ""
output:
...
out <- mutate(test, 
               linear = predict(m, newx = testmat, s = "lambda.min")[,1],
               poisson = predict(mp, newx = testmat, s = "lambda.min", type = "response")[,1]) %>%
