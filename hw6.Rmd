...
- runs one iteration of your `elf` function
- using the `rest` part of the output of `elf` from the *previous* iteration
- and saves the entire output of `elf` for future use
